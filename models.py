...
class Experiencia(db.Model):
    ...
    tipo_empleo = db.Column(db.String(100), nullable=True)
    # Guardamos las fechas como texto en formato 'YYYY-MM' que viene del HTML
    fecha_inicio = db.Column(db.String(7), nullable=True) 
    fecha_fin = db.Column(db.String(7), nullable=True)
...
class Educacion(db.Model):
    ...
    # --- CAMPOS NUEVOS AÑADIDOS ---
    campo_estudio = db.Column(db.String(255), nullable=True)
    fecha_inicio = db.Column(db.String(7), nullable=True)
    fecha_fin = db.Column(db.String(7), nullable=True)
    descripcion = db.Column(db.Text, nullable=True)
...
class Proyecto(db.Model):
    ...
    # --- CAMPOS NUEVOS AÑADIDOS ---
    asociado_con = db.Column(db.String(255), nullable=True)
    tecnologias = db.Column(db.Text, nullable=True)
    enlace_proyecto = db.Column(db.String(255), nullable=True)
    descripcion = db.Column(db.Text, nullable=True)
