document.addEventListener('DOMContentLoaded', function () {
    ...
    // --- LÓGICA GENÉRICA PARA ABRIR Y CERRAR MODALES ---
    // Esta parte es tu código original, que funciona muy bien.
    ...
    // Listener para botones que abren y cierran modales
    ...
    // Listener para cerrar el modal haciendo clic en el overlay
    if (overlay) {
    ...
    // --- NUEVA LÓGICA CENTRALIZADA PARA GUARDAR DATOS DESDE LOS MODALES ---

    /**
     * Función genérica para enviar datos a un endpoint y manejar la respuesta.
    ...
    async function guardarDatos(url, data) {
        try {
            ...
            if (response.ok && result.status === 'success') {
                ...
                // Esta es la forma más sencilla y efectiva de actualizar la vista.
            ...
            // Si hay un error de red, también lo notificamos.
            console.error('Error de red:', error);
            alert('No se pudo conectar con el servidor. Revisa tu conexión.');
        }
    }

    // 1. Listener para el botón "Guardar Experiencia"
    ...
    // 2. Listener para el botón "Guardar Formación"
    ...
    // 3. Listener para el botón "Guardar Proyecto"
